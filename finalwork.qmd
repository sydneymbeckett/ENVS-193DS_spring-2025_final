...
|:------------:|:------:|:-----------------------:|:-------------------------------------------:|
| 1            |No      |No                       |no predictors(null model)                    | 
| 2            |Yes     |Yes                      |all predictors(saturdated model)             | 
| 3            |Yes     |No                       |Predictor variable is season                 |  
| 4            |No      |Yes                      |Predictor variable is distance to forest edge|   
**e)**
