...
sst_plot <- ggplot(data = sst_clean, #using the sst clean data
  ...
  theme( #controlling the other elements of the graph
    ...
    legend.title = element_text(size = 10), #size of title
    legend.text = element_text(size = 9) #text size of title
  )
...
**g)**
The best model as determined by Akaike’s Information Criterion (AIC) is Model 1 with an AICc of 227.0325. **FINISH**
```{r model-selection}
